...
//    Route::get('create.blade.php','Admin\BrandController@create.blade.php'); //添加视图
...
//    Route::get('show/{id}','Admin\BrandController@show');   //访问量方法
...
//    Route::get('create.blade.php','Admin\CategoryController@create.blade.php'); //添加视图
...
//    Route::get('create.blade.php','Admin\GoodsController@create.blade.php'); //添加视图
...
//    Route::get('create.blade.php','Admin\AdminController@create.blade.php'); //添加
...
//
////第二周
////Route::get('/login','Admin\NewssController@index');  //登陆
////Route::post('login/loginDo','Admin\NewssController@NewssDo'); //执行登陆
////Route::post('login/dologin','Admin\NewssController@doNewss'); //执行登陆
//Route::get('/newss','Admin\NewssController@index');  //列表
//Route::get('newss/create.blade.php','Admin\NewssController@create.blade.php'); //添加
//Route::post('newss/store','Admin\NewssController@store'); //执行添加
//Route::get('newss/detail','Admin\NewssController@detail');//详情
////文章模块
//
//
//Route::prefix('article')->middleware('checkUser')->group(function () {
//    Route::get('/','Admin\ArticleController@index'); //列表
//    Route::get('create.blade.php','Admin\ArticleController@create.blade.php'); //添加
...
//    Route::get('return_url','Index\OrderController@return_url')->middleware('UserLogin');  //同步跳转
//
//
...
Route::get('login','admin\MessageLogin@login');
Route::post('login/loginDo','admin\MessageLogin@loginDo');
Route::get('login/loginEdit','admin\MessageLogin@loginEdit');
//留言功能
Route::prefix('message')->middleware('messagelogin')->group(function () {
    Route::get('/','Admin\MessageController@index'); //列表
    Route::get('create','Admin\MessageController@create'); //添加
    Route::post('store','Admin\MessageController@store'); //执行添加
    Route::get('del/{id}','Admin\MessageController@destroy'); //删除
    Route::get('show/{id}','Admin\MessageController@show'); //详情
...
Route::prefix('press')->group(function () {
    Route::get('/', 'Admin\PressController@index'); //列表
    Route::get('create', 'Admin\PressController@create'); //添加
    Route::post('store', 'Admin\PressController@store'); //执行添加
    Route::get('del/{id}', 'Admin\PressController@destroy'); //删除
    Route::get('show/{id}', 'Admin\PressController@show'); //详情
});
