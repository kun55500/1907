...
class GoodsController extends Controller
{
    ...
    public function index()
    {
        ...
        //查询所有分类
        $page=request()->page;
        $data=Cache::get('data_'.$page.'_'.$goods_name.'_'.$brand_id.'_'.$cate_id);
        if(!$data){
            echo '数据库';
        }
        $da=Category::get();
        ...
        Cache::put(['data_'.$page.'_'.$goods_name.'_'.$brand_id.'_'.$cate_id=>$data],60);
        //品牌
        $res=Brand::get();
        //分类
        $da=Category::get();
    ...
    public function create()
    {
        ...
        $data=cateinfo($data);
        $res=Brand::get();
        return view('admin.goods.create.blade.php',['data'=>$data,'res'=>$res]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect('goods/create.blade.php')
